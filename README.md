...
| []_AOI_type | string (NA, 'Movie', 'Genre', 'Forward', 'Backward') | Type of the target Area of Interest (AOI). 'Movie' refers to a movie poster, 'Genre' is the genre/topic text, 'Forward' is the right swipe button, and 'Backward' is the left swipe button. |  
